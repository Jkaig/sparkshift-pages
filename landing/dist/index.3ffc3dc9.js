document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".loading-indicator"),t=document.querySelector(".content"),a="localhost"===window.location.hostname?"/":"/sparkshift-pages",i=window.location.pathname.replace(/\/$/,"");e.classList.add("visible"),t.style.opacity="0.3",i!==a?setTimeout(()=>{window.location.href=`${a}/`},1500):(e.classList.remove("visible"),t.style.opacity="1",document.querySelector(".content").innerHTML=`
        <header class="hero">
...
//# sourceMappingURL=index.3ffc3dc9.js.map
